 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Validate_AlnumUnderscore extends Zend_Validate_Abstract
{
    ...
    public function isValid($value)
    {
        ...
        if (null === self::$_filter) {
             ...
             */
            require_once 'Zend/Filter/AlnumUnderscore.php';
            self::$_filter = new Zend_Filter_AlnumUnderscore();
        }
